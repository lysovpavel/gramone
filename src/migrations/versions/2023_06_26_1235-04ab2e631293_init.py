...
Revision ID: 04ab2e631293
Revises: 
Create Date: 2023-06-26 12:35:58.785497
...
def upgrade() -> None:
    ...
    sa.Column('bot_context', sa.Boolean(), nullable=False),
    sa.Column('bot_context_depth', sa.BigInteger(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
